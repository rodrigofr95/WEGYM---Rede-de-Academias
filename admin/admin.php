    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav ml-auto nav-pills">
          <li class="nav-item"><a class="nav-link" href="#">PORTAL ADMINISTRADOR</a></li>
...
<div class="container">
  <div class="row mb-2">
    ...
    <div class="col-md-6">
      <div class="card flex-md-row mx-5 shadow-sm h-md-250">
        <div class="card-body d-flex flex-column align-items-start">
          <h3 class="mb-0 text-dark">CADASTRAR FUNCIONÁRIO</a></h3>
          <p class="card-text mb-auto">Cadastre aqui os novos funcionários, serão necessários:</p>
          <button id="btnAdd" type="button" class="btn btn-success" data-toggle="modal" data-target="#modalCreateFuncionario">
            Adicionar
          </button>
        </div>
      </div>
    ...
    <div class="col-md-6">
      <div class="card flex-md-row mx-5 shadow-sm h-md-250">
        <div class="card-body d-flex flex-column align-items-start">
          <h3 class="mb-0 text-dark">ATUALIZAR FUNCIONÁRIO</h3>
          <p class="card-text mb-auto">Atualize aqui o cadastro dos Funcionários</p>
          <a href="admin_funcionario_atualizar.php">
  ...
  <div class="row mb-2">
    <div class="col-md-6">
      <div class="card flex-md-row mx-5 shadow-sm h-md-250">
        <div class="card-body d-flex flex-column align-items-start">
          <h3 class="mb-0 text-dark">LISTAR TODOS FUNCIONÁRIOS</h3>
          <p class="card-text mb-auto">Consulte aqui todos os seus funcionários</p>
          <a href="admin_funcionario_consultar.php">
    ...
    <div class="col-md-6">
      <div class="card flex-md-row mx-5 shadow-sm h-md-250">
        <div class="card-body d-flex flex-column align-items-start">
          <h3 class="mb-0 text-dark">LISTAR FUNCIONÁRIO POR CPF</h3>
          <p class="card-text mb-auto">Consulte o seu funcionário através do CPF</p>
          <a href="admin_funcionario_pesquisar_por_cpf.php">
  ...
  <div class="row mb-2">
    <div class="col-md-6 mx-auto">
      <div class="card flex-md-row mx-5 shadow-sm h-md-250">
        <div class="card-body d-flex flex-column align-items-start">
          <h3 class="mb-0 text-dark">EXCLUIR FUNCIONÁRIOS</h3>
          <p class="card-text mb-auto">Exclua aqui o cadastro do seu funcionário através do CPF</p>
          <a href="admin_funcionario_deletar.php">
  ...
  <div class="row mb-2">
    ...
    <div class="col-md-6">
      <div class="card flex-md-row mx-5 shadow-sm h-md-250">
        <div class="card-body d-flex flex-column align-items-start">
          <h3 class="mb-0 text-dark">CADASTRAR ALUNO</h3>
          <p class="card-text mb-auto">Gerencie os seus Alunos</p>
          <button id="btnAdd" type="button" class="btn btn-success" data-toggle="modal" data-target="#modalCreateAluno">
            Adicionar
          </button>
        </div>
      </div>
    ...
    <div class="col-md-6">
      <div class="card flex-md-row mx-5 shadow-sm h-md-250">
        <div class="card-body d-flex flex-column align-items-start">
          <h3 class="mb-0 text-dark">ATUALIZAR ALUNO</h3>
          <p class="card-text mb-auto">Atualize aqui o cadastro dos alunos</p>
          <a href="admin_aluno_atualizar.php">
            <button class="btn btn-primary">Pesquisar</button>
          </a>          
        </div>
      </div>
    ...
    <div class="col-md-6">
      <div class="card flex-md-row mx-5 shadow-sm h-md-250">
        <div class="card-body d-flex flex-column align-items-start">
          ...
          <a href="admin_aluno_consultar.php">
            <button class="btn btn-primary">Pesquisar</button>
          </a>          
        </div>
      </div>
    ...
    <div class="col-md-6">
      <div class="card flex-md-row mx-5 shadow-sm h-md-250">
        <div class="card-body d-flex flex-column align-items-start">
          ...
          <a href="admin_aluno_pesquisar_por_cpf.php">
            <button class="btn btn-primary">Pesquisar</button>
          </a>          
        </div>
      </div>
  ...
  <div class="row mb-2">
    <div class="col-md-6 mx-auto">
      <div class="card flex-md-row mx-5 shadow-sm h-md-250">
        <div class="card-body d-flex flex-column align-items-start">
          <h3 class="mb-0 text-dark">EXCLUIR ALUNOS</h3>
          <p class="card-text mb-auto">Exclua aqui o cadastro do seu aluno através do CPF</p>
          <a href="admin_aluno_deletar.php">
            <button class="btn btn-danger">Deletar</button>
          </a>
        </div>
      </div>
