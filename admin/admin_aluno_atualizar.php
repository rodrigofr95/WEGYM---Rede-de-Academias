...
if (!$conn) {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $cpf = $_POST['cpf'];
        $sql_cpf = "SELECT * FROM usuario INNER JOIN aluno ON aluno.idusuario = usuario.id WHERE cpf='$cpf'";
...
<main>
    <div class="jumbotron p-md-5 text-white bg-dark">
        <div class="col-md px-0">
            ...
            <h5 class="font-italic color-white">ATUALIZAR CADASTRO DE ALUNO</h5>
        </div>
    </div>

    <div class="container">
        <h1>Insira o CPF do aluno que deseja atualizar:</h1>
        ...
        <?php if (isset($cpf) && !isset($cpfNotFound)) { ?>
            <div class="container">
                <form method="post" action="aluno_atualiza.php">
