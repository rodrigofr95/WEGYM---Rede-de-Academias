...
<main>
  <div class="jumbotron p-md-5 text-white bg-dark">
    <div class="col-md px-0">
      ...
      <h5 class="font-italic color-white">CONSULTAR FUNCIONÁRIO</h5>
    </div>
  </div>
      ...
      <tbody>
        ...
        if ($_SERVER["REQUEST_METHOD"] == "GET") {
          ...
          if (!$conn) {
            ...
            $sql_alunos = "SELECT * FROM usuario  INNER JOIN funcionario ON funcionario.idusuario = usuario.id ORDER BY nome";
